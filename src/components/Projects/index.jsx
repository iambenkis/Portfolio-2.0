...
export default function Projects() {
  const toDisplay = 4
  return (
    <section className="px-7 md:px-0 mt-10">
      <div>
        ...
        <Link
          type="button"
          class="flex justify-center items-center text-sm my-7 mx-auto px-4 py-2 rounded-md font-medium text-gray-900 dark:text-gray-100"
          href="/projects"
        >
          See More
          <svg
